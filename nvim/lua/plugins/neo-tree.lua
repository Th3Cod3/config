      ...
      filesystem = {
        window = {
          ...
          mappings = {
            ...
            ['zc'] = { ntc.neotree_zc, desc = 'Fold' },
            ['zC'] = { ntc.neotree_zC, desc = 'Fold recursively' },
            ...
            ['zm'] = { ntc.neotree_zm, desc = 'Unfold more' },
            ['zM'] = { ntc.neotree_zM, desc = 'Unfold all' },
            ['zr'] = { ntc.neotree_zr, desc = 'Fold more' },
            ['zR'] = { ntc.neotree_zR, desc = 'Fold all' },
            ['h'] = { ntc.neotree_zc, desc = 'Fold' },
            ['l'] = { ntc.neotree_zo, desc = 'Unfold' },
            ...
            ['<C-O>'] = { ntc.open_with_xdg, desc = 'Open with xdg-open' },
            -- upload (sync files)
            uu = {
