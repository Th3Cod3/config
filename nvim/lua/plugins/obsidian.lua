return {
  {
    ...
    keys = {
      ...
      { '<leader>ol', '<cmd>Obsidian link<cr>', desc = 'Obsidian: Create Link', mode = { 'n', 'v' } },
      ...
      { '<leader>oe', '<cmd>Obsidian extract_note<cr>', desc = 'Obsidian: Extract Note' },
    ...
    opts = {
      ...
      workspaces = {
        ...
        {
          name = 'notes-no-tech',
          path = '~/code/Th3Cod3/notes-no-tech/',
        },
      },
    },
  },
